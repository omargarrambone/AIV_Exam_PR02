...
public enum FinalBossPhase { PhaseAttack, PhaseMinions, PhaseRythm, LAST }
public enum ItemType { Fists, SmallKatana, LongKatana, Rod, Flute, LAST }
public enum CameraType { FollowPlayer, LookAtPlayer, DiabloCamera, DiabloCameraSlums, MazeCamera, SavingCamera, MinionsPhaseBossBattleCamera, LAST}
